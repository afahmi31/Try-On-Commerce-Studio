...
<head>
    ...
    <?php if($seoImage !== ''): ?>
    <link rel="icon" type="image/png" href="<?php echo e($seoImage); ?>?v=<?php echo e(urlencode($faviconVersion)); ?>">
    <link rel="shortcut icon" href="<?php echo e($seoImage); ?>?v=<?php echo e(urlencode($faviconVersion)); ?>">
    <link rel="apple-touch-icon" href="<?php echo e($seoImage); ?>?v=<?php echo e(urlencode($faviconVersion)); ?>">
    <?php endif; ?>
...
<body>
    <div class="topbar-wrap">
        <header class="topbar">
            <div class="brand">
                <span class="brand-label"><?php echo e(__('ui.common.products')); ?></span>
            </div>
        </header>
    </div>
    ...
    <main class="wrap">
        <div class="catalog-toolbar">
            <form method="GET" action="<?php echo e(route('public.seller.page', ['seller_slug' => $seller->slug])); ?>">
                <input
                    class="catalog-field catalog-search"
                    type="search"
                    name="q"
                    value="<?php echo e($activeFilters['q']); ?>"
                    placeholder="<?php echo e(__('ui.store.search_placeholder')); ?>">
                <select class="catalog-field" name="category">
                    <option value=""><?php echo e(__('ui.store.all_categories')); ?></option>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryOption): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($categoryOption); ?>" <?php echo e($activeFilters['category'] === $categoryOption ? 'selected' : ''); ?>>
                ...
                <select class="catalog-field" name="sort">
                    <option value="latest" <?php echo e($activeFilters['sort'] === 'latest' ? 'selected' : ''); ?>><?php echo e(__('ui.store.sort_latest')); ?></option>
                    <option value="name_asc" <?php echo e($activeFilters['sort'] === 'name_asc' ? 'selected' : ''); ?>><?php echo e(__('ui.store.sort_name_asc')); ?></option>
                    <option value="name_desc" <?php echo e($activeFilters['sort'] === 'name_desc' ? 'selected' : ''); ?>><?php echo e(__('ui.store.sort_name_desc')); ?></option>
                </select>
                <button class="catalog-btn" type="submit"><?php echo e(__('ui.store.apply')); ?></button>
                <a class="catalog-btn catalog-btn-ghost" href="<?php echo e(route('public.seller.page', ['seller_slug' => $seller->slug])); ?>"><?php echo e(__('ui.store.reset')); ?></a>
            </form>
        </div>

        <?php if($products->isEmpty()): ?>
        <div class="empty"><?php echo e(__('ui.products_page.no_products')); ?></div>
        <?php else: ?>
        <section class="grid" id="productGrid">
            ...
            <button
                type="button"
                class="card <?php echo e($isSelected ? 'selected' : ''); ?>"
                ...
                data-product-image="<?php echo e($image?->image_url ?? ''); ?>"
                onclick="openTryOnModal(this)">
                <div class="thumb-wrap">
                    <?php if($image): ?>
                    <img src="<?php echo e($image->image_url); ?>" alt="<?php echo e($product->name); ?>" class="thumb">
                    <?php else: ?>
                ...
                <div class="card-body">
                    ...
                    <p class="meta">Category: <?php echo e($product->category ?: '-'); ?></p>
                </div>
            </button>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </section>
        <div class="catalog-footer-row">
            <p class="catalog-meta">
                <?php echo e(__('ui.store.showing_summary', ['count' => $products->count(), 'total' => $products->total()])); ?>
            ...
            <nav class="catalog-pagination" aria-label="Pagination produk">
                <?php if($products->onFirstPage()): ?>
                    <span>&laquo;</span>
                <?php else: ?>
                    <a href="<?php echo e($products->previousPageUrl()); ?>" rel="prev">&laquo;</a>
                <?php endif; ?>
                ...
                <?php if($products->hasMorePages()): ?>
                    <a href="<?php echo e($products->nextPageUrl()); ?>" rel="next">&raquo;</a>
                <?php else: ?>
                    <span>&raquo;</span>
                <?php endif; ?>
            </nav>
        ...
        <?php if(!empty($selectedProduct)): ?>
            ...
            <button
                ...
                style="display:none"
                aria-hidden="true"
                data-product-id="<?php echo e($selectedProduct->id); ?>"
                data-product-name="<?php echo e($selectedProduct->name); ?>"
                data-product-slug="<?php echo e($selectedProduct->slug); ?>"
                data-product-sku="<?php echo e($selectedProduct->sku); ?>"
                data-product-category="<?php echo e($selectedProduct->category); ?>"
                data-product-image="<?php echo e($selectedProductImage?->image_url ?? ''); ?>">
            </button>
        <?php endif; ?>
        <button id="floatingHistoryBtn" type="button" class="floating-history-btn" aria-label="<?php echo e(__('ui.store.history_button_aria')); ?>">
            &#128340;
        </button>
        <div id="floatingHistoryPanel" class="floating-history-panel" aria-hidden="true">
            <div class="floating-history-header">
                <p class="floating-history-title"><?php echo e(__('ui.store.history_title')); ?></p>
                <button id="floatingHistoryClose" type="button" class="floating-history-close" aria-label="<?php echo e(__('ui.common.close')); ?>">&times;</button>
            </div>
            <div id="floatingHistoryList" class="history-list"></div>
            <p id="floatingHistoryEmpty" class="history-empty"><?php echo e(__('ui.store.no_history')); ?></p>
        </div>
    </main>
        ...
        <div class="modal" role="dialog" aria-modal="true" aria-labelledby="tryOnModalTitle">
            <div class="modal-header">
                <div class="modal-title-row">
                    <h2 class="modal-title" id="tryOnModalTitle"><?php echo e(__('ui.store.tryon_tool_title')); ?></h2>
                    <?php if(($tryOnDummy['enabled'] ?? false) === true): ?>
                        <span class="dummy-mode-badge"><?php echo e(__('ui.store.dummy_mode')); ?></span>
                    <?php endif; ?>
                </div>
                <button type="button" class="modal-close" onclick="closeTryOnModal()" aria-label="<?php echo e(__('ui.common.close')); ?>">&times;</button>
            </div>

            <div class="modal-info-grid">
                <div id="selectedProductInfo" class="selected-product">
                    <?php echo e(__('ui.common.products')); ?>: <strong id="selectedProductName">-</strong>
                </div>
                <div id="quotaBox" class="quota-box">
                    <?php echo e(__('ui.store.quota_today_remaining')); ?>: <strong id="remainingQuotaText">-</strong>
                </div>
            </div>
            ...
            <div class="tryon-main-grid">
                <div class="tryon-left-rail">
                    <div class="field">
                        <div class="tryon-panel-head">
                            <label class="label"><?php echo e(__('ui.store.product_photo')); ?></label>
                        </div>
                        <div class="selected-product-thumb preview-box preview-box-product" aria-label="<?php echo e(__('ui.store.selected_product_alt')); ?>">
                            <img id="selectedProductPreview" alt="<?php echo e(__('ui.store.selected_product_alt')); ?>" style="display:none;">
                            <span id="selectedProductPreviewFallback" class="selected-product-thumb-fallback"><?php echo e(__('ui.store.no_image')); ?></span>
                        </div>
                    </div>

                    <div class="field">
                        <div class="model-footer-row">
                            <label class="label"><?php echo e(__('ui.store.model_photo')); ?></label>
                            <label class="dummy-toggle" id="dummyModelToggleWrap" style="display:none;">
                                ...
                                <span class="dummy-toggle-text"><?php echo e(__('ui.store.use_dummy')); ?></span>
                            </label>
                        </div>
                        <div class="preview-box preview-box-model">
                            <img id="customerPreview" alt="Customer preview">
                            <button id="removePhotoBtn" class="preview-remove" type="button" aria-label="<?php echo e(__('ui.store.remove_photo_aria')); ?>">&times;</button>
                            <div id="customerPlaceholder" class="preview-placeholder">
                                <p><?php echo e(__('ui.store.upload_photo')); ?></p>
                                <button type="button" class="upload-trigger" onclick="document.getElementById('customerPhoto').click()"><?php echo e(__('ui.store.choose_file')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="field tryon-generated-field">
                    <div class="tryon-panel-head">
                        <label class="label"><?php echo e(__('ui.store.tryon_generated')); ?></label>
                        <span class="ready-badge"><?php echo e(__('ui.store.ready')); ?></span>
                    </div>
            ...
            <button id="generateBtn" class="generate-btn" type="button" onclick="submitTryOn()"><?php echo e(__('ui.store.tryon_action')); ?></button>
        </div>
    </div>

    <script>
        const I18N = {
            selectProductFirst: <?php echo json_encode(__('ui.store.select_product_first'), 15, 512) ?>,
            generateDone: <?php echo json_encode(__('ui.store.generate_done'), 15, 512) ?>,
            uploadModelFirst: <?php echo json_encode(__('ui.store.upload_model_first'), 15, 512) ?>,
            dailyLimitReached: <?php echo json_encode(__('ui.store.daily_limit_reached'), 15, 512) ?>,
            failedCreateSession: <?php echo json_encode(__('ui.store.failed_create_session'), 15, 512) ?>,
            failedCheckStatus: <?php echo json_encode(__('ui.store.failed_check_status'), 15, 512) ?>,
            failedPolling: <?php echo json_encode(__('ui.store.failed_polling'), 15, 512) ?>,
            historyResultShown: <?php echo json_encode(__('ui.store.history_result_shown'), 15, 512) ?>,
            historyItemAria: <?php echo json_encode(__('ui.store.history_button_aria'), 15, 512) ?>,
            historyImageAlt: <?php echo json_encode(__('ui.store.tryon_generated'), 15, 512) ?>,
            dummyModelUrlMissing: <?php echo json_encode(__('ui.store.dummy_model_url_missing'), 15, 512) ?>,
            dummyResultUrlMissing: <?php echo json_encode(__('ui.store.dummy_result_url_missing'), 15, 512) ?>,
            processingRetryLater: <?php echo json_encode(__('ui.store.processing_retry_later'), 15, 512) ?>,
        };

        let selectedProductId = <?php echo json_encode(optional($selectedProduct)->id, 15, 512) ?>;
        let pollTimer = null;
        const TRYON_DEVICE_KEY = 'tryon_device_id_v1';
        const TRYON_DUMMY = <?php echo json_encode($tryOnDummy ?? ['enabled' => false, 'model_image_url' => '', 'result_url' => '']) ?>;
        const TRYON_HISTORY_URL = <?php echo json_encode(route('public.tryon.sessions.history', ['seller_slug' => $seller->slug]), 512) ?>;
        ...
        function selectProduct(el) {
            ...
            if (productRef) {
                const newUrl = `/${<?php echo json_encode($seller->slug, 15, 512) ?>}/${productRef}`;
        ...
        async function refreshQuota() {
            try {
                const response = await fetch(<?php echo json_encode(route('public.tryon.quota.show', ['seller_slug' => $seller->slug]), 512) ?>, {
                    headers: {
                        'Accept': 'application/json',
                        'X-Tryon-Device-Id': resolveTryOnDeviceId(),
                    },
        ...
        async function submitTryOn() {
            ...
            try {
                ...
                const createResponse = await fetch(<?php echo json_encode(route('public.tryon.sessions.store', ['seller_slug' => $seller->slug]), 512) ?>, {
                    method: 'POST',
                    headers: {
                        'X-CSRF-TOKEN': csrf,
                        'X-Tryon-Device-Id': resolveTryOnDeviceId(),
        ...
        async function pollTryOnStatus(sessionId) {
            const resultPreview = document.getElementById('resultPreview');
            const resultPlaceholder = document.getElementById('resultPlaceholder');
            const statusUrlBase = <?php echo json_encode(url('/'), 15, 512) ?>;
            ...
            pollTimer = setInterval(async () => {
                attempts += 1;
                try {
                    const response = await fetch(`${statusUrlBase}/${<?php echo json_encode($seller->slug, 15, 512) ?>}/try-on/sessions/${sessionId}`, {
                        headers: {
                            'Accept': 'application/json'
                        },
                    });
...
<?php /**PATH D:\AI Virtual Try-On Platform\Try-On-Commerce-Studio\resources\views/public/seller.blade.php ENDPATH**/ ?>